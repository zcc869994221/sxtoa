		 ...
		 function delEmp(empid){
			 ...
			 if(confirm("您确定要删除吗?")){
				 $.ajax({
						type: "post",
						   url: "EmployeeServlet",
						   data: "empid="+empid+"&method=delEmp",
						   success: function(meg){
							  alert(meg);
							  window.location.href="EmployeeServlet?method=findAll";
						   }
					}); 		
			  }
		  }
				...
				<c:forEach items="${list}" var="emp">
					<tr>
						...
						<td>
							...
							<a href="EmployeeServlet?method=findById&empid=${emp.empid}" class="tablelink">修改</a> 
							<a href="javascript:void(0)" class="tablelink" onclick="delEmp('${emp.empid}')">删除</a>
