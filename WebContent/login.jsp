...
<body
	...
	<form action="EmployeeServlet?method=login" method="post">
		<ul>
					<li><input name="empid" type="text" class="loginuser" value=""
						onclick="JavaScript:this.value=''" />
						<br />
						${error}
						</li>
					<li><input name="password" type="text" class="loginpwd" value=""
						onclick="JavaScript:this.value=''" /></li>
					<li class="yzm"><span><input name="yzm" type="text"
							value="验证码" onclick="JavaScript:this.value=''"/></span><cite><img src="random.jpg"  id = "randImg" onclick="changeRandom()"/></cite>
							<br />
							${yzmError}
					</li>
